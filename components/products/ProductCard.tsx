    ...
    return (
        ...
        >
            <div className={`${isAvailable(product.inventory) ? "" : "opacity-50" }`}> 
                <Image 
                    placeholder="empty" //mejor rendimiento de carga
                    src={getImagePath(product.image)} // funcion que resuelve autpmaticamente la ubicacion de la imagen
            ...
            />
                    ...
                    <p className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white opacity-60
                    w-full text-center py-5 text-2x1 uppercase font-black">Agotado</p>
        )}
        </div>
    )
}